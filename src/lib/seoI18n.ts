...
const ROUTE_DESCRIPTIONS: Record<RouteKey, string> = {
  ...
  "/univers": "Univers Lovanet : entrée rapide vers les vidéos, le magasin, le catalogue, les actualités et les services du compte.",
  ...
  "/tiktok": "TikTok Lovanet : shorts anime, réactions rapides et bibliothèque verticale officielle.",
...
const TITLES: Record<Locale, Record<RouteKey, string>> = {
  fr: {
    ...
    "/tiktok": "TikTok : Lovanet shorts anime",
  ...
  en: {
    ...
    "/prime-video": "Prime Video : Lovanet streaming",
    "/tiktok": "TikTok : Lovanet anime shorts",
