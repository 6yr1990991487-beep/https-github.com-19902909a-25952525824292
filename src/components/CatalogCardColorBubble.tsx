  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-2 top-1/2 z-[60] flex h-12 w-12 -translate-y-1/2 items-center justify-center overflow-hidden rounded-full border border-white/35 bg-white/10 text-white shadow-[0_10px_30px_rgba(0,0,0,0.45)] backdrop-blur-xl transition-all hover:scale-110 sm:right-3"
      >
        <span
