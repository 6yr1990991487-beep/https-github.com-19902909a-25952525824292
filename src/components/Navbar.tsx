...
const mobileGroups = [
  ...
  },
  {
    id: "explore",
    label: "Explorer & Plus",
    items: megaSections.filter((item) => ["/", "/univers", "/actualites", "/leaderboard", "/profile", "/contact", "/legals"].includes(item.to)),
    color: "text-sky-400",
...
export const Navbar = () => {
  ...
  const renderLogo = () => (
    ...
    >
      ...
      >
        <img
          src="/lovanet-logo-round.png?v=14"
          alt="Lovanet"
